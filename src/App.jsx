  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/assign-certificates" element={
          <>
        ...
        <Route path="/chapters-list" element={
          <>
            <PageTitle title="Chapters List | Tajurba" />
            <ChaptersList />
          </>
        } />
        <Route path="/creative-list" element={
          <>
        ...
        <Route path="/attendance-venue-fee" element={
          <>
            <PageTitle title="Attendance & Venue Fee | Tajurba" />
            <AttendanceVenueFee />
          </>
        } />
        <Route path="/mark-venue-fee" element={
          <>
        ...
        <Route path="/view-schedule/:id" element={
          <>
        ...
        <Route path="/visitor-list" element={
          <>
            <PageTitle title="Visitor List | Tajurba" />
            <VisitorList />
          </>
        } />
        <Route path="/monthly-reward" element={
          <>
            <PageTitle title="Monthly Reward | Tajurba" />
            <MonthlyReward />
          </>
        } />
        <Route path="/member-levels" element={
          <>
        ...
        <Route path="/add-bdm" element={
          <>
            <PageTitle title="Add BDM | Tajurba" />
            <AddBDM />
          </>
        } />
        <Route path="/edit-bdm/:id" element={
          <>
            <PageTitle title="Edit BDM | Tajurba" />
            <AddBDM />
          </>
        } />
        <Route path="/view-bdm/:id" element={
          <>
            <PageTitle title="View BDM | Tajurba" />
            <ViewBDM />
          </>
        } />
        <Route path="/business-given" element={
          <>
        ...
        <Route path="edit-visitor/:id" element={
          <>
            <PageTitle title="Edit Visitor | Tajurba" />
            <VisitorInviteAddEdit />
          </>
        } />
        <Route path="view-visitor/:id" element={
          <>
