...
const ViewScheduleMeeting = () => {
  ...
  const schedule = {
    ...
    description: "Monthly meeting to discuss chapter progress and upcoming events. All members are requested to attend.",
    ...
    additional_notes: "Please bring your member ID cards. Refreshments will be provided.",
  ...
  const getTypeColor = (type) => {
    switch (type) {
      ...
      case "mdp": return "purple";
      case "socialTraining": return "orange";
      default: return "gray";
    }
  };
  ...
  const getTypeName = (type) => {
    switch (type) {
      case "socialTraining": return "Social Training";
      case "mdp": return "MDP";
    ...
    <div className="mt-24 px-6 pb-6">
        ...
        <div className="relative">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-bold text-white">{schedule.title}</h1>
              <p className="mt-2 text-gray-400 max-w-2xl">{schedule.description}</p>
            </div>
            <button
              onClick={() => navigate(-1)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-800/50 border border-gray-700/50">
              ...
              <div>
                ...
                <p className="text-white font-medium">{formatDateTime(schedule.date, schedule.time)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-800/50 border border-gray-700/50">
              ...
              <div>
                ...
                <p className="text-white font-medium">{formatCurrency(schedule.fee_amount)}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          {/* Chapters Card */}
          <div className="p-6 rounded-2xl bg-gray-800 border border-gray-700">
            <h2 className="text-xl font-semibold text-white mb-4">Participating Chapters</h2>
        ...
        >
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-700/50">
                <div className="flex flex-col items-center">
                  ...
                  {schedule.upi_id && (
                    <p className="text-sm text-gray-400">UPI: {schedule.upi_id}</p>
                  )}
                </div>
              </div>
            </div>
          ...
          {/* Participants Card */}
          <div className="p-6 rounded-2xl bg-gray-800 border border-gray-700">
            <h2 className="text-xl font-semibold text-white mb-4">Participation</h2>
            <div className="space-y-4">
              ...
              <div className="relative h-2 bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(schedule.current_participants / schedule.max_participants) * 100}%`
                  }}
                />
              </div>
            </div>
