        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-sm text-gray-400">
              Manage all creative sliders content
            </h2>
          </div>
        </div>
          ...
          {creatives.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500 mt-2">
                Click the "Add New Creative Slider" button to create one.
              </p>
            </div>
          ) : (
            creatives.map((creative) => (
              <div
                ...
                className="bg-gray-800/50 rounded-xl border border-gray-700 p-6 hover:shadow-lg transition-all duration-300"
              >
                ...
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  ...
                  <span className="text-gray-300">
                    {formatDate(creative.display_until, true)}
                  </span>
                </div>
              </div>
            ))
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full p-3 bg-gray-700/50 rounded-xl border border-gray-600 focus:border-amber-500 focus:ring-0 text-white [color-scheme:dark]"
                  />
                </div>
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-300">
