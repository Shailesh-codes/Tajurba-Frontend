...
const UsersList = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await api.get("/members/regional-directors", {
          params: {
        ...
        showToast({
          title: "Error",
          message: "Failed to load regional directors",
          status: "error",
        });
        setLoading(false);
      }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              View and manage regional directors
            </p>
          </div>
        </div>
        <button
